...
if __name__ == "__main__":
    ...
    if memberships_matrix.shape[1] > 0:
        for i, doc_set in enumerate(kmart_model.clusters_):
            ...
            print(f"Cluster {i+1}:")
            print(
                f"  Representative Words: {sorted(list(kmart_model.cluster_words_[i]))}"
            )
        ...
        print(
            "No clusters were formed. This may be due to the nature of the input documents or the algorithm's parameters."
        )
